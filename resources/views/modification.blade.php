                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 pl-xl-0 pl-lg-0 pl-md-0 border-left m-b-30">
                                <div class="product-details">
                                    <div class="border-bottom pb-3 mb-3">
                                        ...
                                        <h2 class="mb-3"><input type="text" name="nom" value="{{$produit['nom']}}"></input></h2>
                                        <h3 class="mb-0 text-primary">$<input type="text" name="prix" value="{{$produit['prix']}}" ></h3>
                                    </div>
                                    <div class="product-size border-bottom">
                                        <h4>Fournisseur</h4>
                                        <input type="text" name="fourniseur" value="{{$produit['fourniseur']}}">
